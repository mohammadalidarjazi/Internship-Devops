...
پس از آن با kafka کار خواهیم کرد  و با مفاهیم producer , consumer  در کافکا آشنا خواهیم شد. انتظار میرود موارد مرتبط را با سرچ خودتان مطالعه کنید
 ...
 1. در مورد مفاهیم زیر جتسجو کنید
    - لاگ چیست
    - log چه اهیمیتی دارد
    - برای بررسی log از چه ابزار هایی استفاده می شود؟
 ...
 1. elsastic search
    یک موتور جستجو مبتنی بر پایگاه داده غیر رابطه ای است که در logmanagement به عنوان انباره داده برای ذخیره و جستجو لاگ ها بکار برده میشود
    - elastic search چیست؟
 ...
 1. kibana
     ابزاری است که برای مدیریت، پایش، جستجو و ویژالایز کردن elasticsearch استفاده میشود
    - kibana چیست؟
    - نحوه نصب kibana
    - کانفیگ کردن kibana:
        - اتصال به الستیک سرچ
 ...
 1. logstash
     یک ابزار ETL است که در پشته Log management برای پردازش لاگ ها استفاده می شود
    - logstash چیست؟
    - نحوه نصب logstash
...
kafka یک ابزار مدیریت صف است که از آن می توان در پشته مدیریت log برای افزایش پایداری استفاده کرد
